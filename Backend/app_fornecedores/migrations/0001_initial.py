    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cadastrado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fornecedores_cadastrados', to='app_admin.admin')),
